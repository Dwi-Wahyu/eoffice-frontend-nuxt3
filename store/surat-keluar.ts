...
export const useMySuratKeluarStore = defineStore({
  id: "mySuratKeluarStore",
  state: () => ({
    currentPage: 1,
    totalPages: 10,
    perPage: 5,
    ...
    async getData(payload: any) {
      ...
      return new Promise((resolve, reject) => {
        const dataExample = [
          ...
          {
            id: "afekjalflakwefjaawefwfkafjaljffwae",
            nomor_surat: "09790/UN4.1KEP/2024",
            perihal: "SK PENGANGKATAN KEPALA SUBBAGIAN",
            pengirim: "Kurniawan",
            penerima: "Dedi",
            tanggal: "11 Sep 2024",
            sifat: "Biasa",
          ...
          {
            id: "afewlkejflkwjeflkjlwekfjllwkfjlwke",
            nomor_surat: "42623/UN4.1.2.5DL/24",
