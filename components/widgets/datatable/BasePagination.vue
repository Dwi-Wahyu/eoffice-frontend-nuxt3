<template>
  <div>
    ...
    <div class="flex items-center justi fy-center space-x-2 select-none">
      ...
      <button
        class="pl-3 text-sm font-medium text-[#0C7BEE] disabled:text-[#C1CDD8] disabled:cursor-not-allowed"
      ...
      <!-- Tombol Berikutnya -->
      <button
        class="pr-3 text-sm font-medium text-[#0C7BEE] disabled:text-[#C1CDD8] disabled:cursor-not-allowed"
